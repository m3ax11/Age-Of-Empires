...
PixelShader = 
{
	...
	{
		// AOEIW uses a permanent dusk presentation for the strategic map.
		// A partial night blend keeps city emissive lights active while terrain,
		// state colours and borders remain readable.
		return 0.42f;
	}
