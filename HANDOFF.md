...
The major-power standing rule is now explicit: theatres remain compatible by default unless a specific political or logistical conflict makes simultaneous pursuit implausible. Russia is next. Its divergence-aware structural report is complete in `FOCUS_STRUCTURE_REWORK.md`, but **no Russian implementation is authorized yet**. Per-country approval remains mandatory for Russia, USA, United Kingdom, Austria-Hungary, Italy and Japan.
