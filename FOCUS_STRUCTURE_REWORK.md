...
Permanent reward profiles introduced or proposed by this pass are tracked in `FOCUS_REWARD_PROFILE_REGISTER.md`. Every new proposal must compare profiles within the same decision type; sharing at least two of three principal modifier categories is a conflict that must be redesigned before implementation.
...
4. Add four distinct permanent method profiles to the existing focuses:
   - Atlantic mission: convoy escort, naval detection and naval coordination. This represents Admiralty control rooms, trade-route intelligence and coordinated escort groups rather than another generic fleet-expansion bonus.
   - Atlantic economic pressure: dockyard construction speed, tighter imperial-subject economic control and trade influence. This represents Imperial Preference and the sterling network rather than copying French or American consumer-goods relief.
   - Continental mission: planning speed, reinforcement rate and army defence. This models the professional British Expeditionary Force and its ability to deploy and hold a continental line rather than copying French frontier forts.
   - Continental economic pressure: intelligence-network growth, military-factory output and war support. This models the Ministry of Economic Warfare, industrial mobilisation and blockade planning rather than another rail-and-fort package.
   Existing immediate rewards remain attached to their IDs. Each profile was checked against the central register and avoids matching two of three categories used by another country for the same decision type.
...
| Choice | Before | Proposed outcome | Assessment |
|---|---|---|---|
| Atlantic mission vs economic pressure | Sequential; immediate command resources followed by generic economic pressure | Admiralty detection/coordination/escort versus Imperial Preference, dockyard expansion and subject control | **Insufficient structure**, corrected with mutex and country-specific persistent categories. |
| Continental mission vs economic pressure | Sequential copy of the Atlantic pattern with Germany as target | BEF planning/reinforcement/defence versus economic-warfare intelligence, arms output and war support | **Insufficient structure**, corrected without copying French land preparation. |
...
- The four method spirits use the registered Admiralty, Imperial Preference, expeditionary-army and economic-warfare categories without a 2/3 conflict.
...
### Cross-country divergence check

| Proposed British profile | Nearest existing profile | Shared categories | Result |
|---|---|---|---|
| Atlantic mission: escort, detection, coordination | USA Atlantic mission: escort, naval organisation, naval-base construction | Escort only (1/3) | **No conflict**. British Admiralty intelligence and command coordination provide the national distinction. |
| Atlantic economic pressure: dockyard construction, subject control, trade influence | France Mediterranean commerce / USA Pacific commerce | Trade influence only; dockyard construction speed is distinct from dockyard output (1/3) | **No conflict**. Imperial Preference and dominion control are specifically British. |
